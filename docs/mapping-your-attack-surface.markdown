...
- [Mapping Your Attack Surface]({{ '/mapping-your-attack-surface/old-readme-file/' | relative_url }})

Previous: [Understanding the Adversary]({{ '/cyber-attacks-and-defense-threat-intelligence-adversaries-and-collective-defense/' | relative_url }})

Next: [CIS18 and Basic Security Controls]({{ '/overview-of-cis18-critical-security-controls/' | relative_url }})
