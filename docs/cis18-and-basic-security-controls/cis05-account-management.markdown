...
permalink: /cis18-and-basic-security-controls/cis05-account-management/
description: 'What does this really mean in the real world?'
---
...
Also, be sure to visit the CIS18 section on [Access Control Management](https://github.com/CroodSolutions/CISOinaBox/edit/main/05%20-%20CIS18%20and%20Basic%20Security%20Controls/CIS06%20-%20Access%20Control%20Management.md) and the CISO-in-a-Box section on [Identity and Access Management](/identity-and-access-management/).
