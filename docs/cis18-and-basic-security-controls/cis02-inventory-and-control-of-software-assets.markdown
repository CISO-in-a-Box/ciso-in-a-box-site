...
permalink: /cis18-and-basic-security-controls/cis02-inventory-and-control-of-software-assets/
description: 'The goal is to understand, track, and manage the different kinds of software deployed across the environment.'
---

[Back to CIS18 and Basic Security Controls](/cis18-and-basic-security-controls/)
...
A huge portion of this also has cross-over into [Data Protection](/cis18-and-basic-security-controls/cis03-data-protection/), as Enterprise Software solutions and projects require integrations between software systems; as well as [Account](/cis18-and-basic-security-controls/cis05-account-management/) and [Access Control](/cis18-and-basic-security-controls/cis06-access-control-management/) since non-human identities, proper scoping of access levels and permissions, and BYOID/SSO are often important elements of such projects. 

## MITRE ATT&CK Techniques Mitigated 

**ATT&CK Relevance:** Directly counters Execution tactics (T1204, T1059) and Persistence via trojaned software (T1554). Application allowlisting is one of the single most effective controls against malware execution, although in large and complex environments and ecosystems it can prove elusive at times. This is where control of software assets will often lead into the [Malware Defence](/cis18-and-basic-security-controls/cis10-malware-defenses/) and [Incident Response](/cis18-and-basic-security-controls/cis17-incident-response-management/) topics.  
