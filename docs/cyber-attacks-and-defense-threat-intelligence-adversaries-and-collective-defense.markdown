...
- [Supplemental: Frameworks for Defending Against Attacks — PICERL, MITRE, and Beyond]({{ '/cyber-attacks-and-defense-threat-intelligence-adversaries-and-collective-defense/chapter03-supplemental-defense-frameworks/' | relative_url }})
- [Supplemental: How Cyber Attacks Work — The Attack Kill Chain]({{ '/cyber-attacks-and-defense-threat-intelligence-adversaries-and-collective-defense/chapter03-supplemental-attack-kill-chain/' | relative_url }})
- [Supplemental: Top Resources for Understanding Emerging Threats]({{ '/cyber-attacks-and-defense-threat-intelligence-adversaries-and-collective-defense/chapter03-supplemental-threat-intelligence-resources/' | relative_url }})
